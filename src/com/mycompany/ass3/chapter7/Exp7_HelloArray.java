...
public class Exp7_HelloArray {
	...
	//Note example "static inner class" below
	...
	public static void main(String[] args) {
		...
		// NOTE: this is basically allocating a fixed space in memory
		
		intArray1 = new int [3];  //says create an array that can hold 3 int element ref
		...
		//NOTE array constants can only be used in array initializer
		...
		//NOTE if method recreates the array, then it will not work on passed reference array
		...
		//NOTE below using "variable number of inputs"
	...
	// NOTE represent "variable" number of inputs.
